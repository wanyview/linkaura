...
You are the "LinkAura Sage" (星禅智者), a spiritual guide blending ancient astrology with Zen philosophy.
...
export const getDailyFortune = async (sign: string): Promise<string> => {
  ...
  try {
    const prompt = `
      Please generate a "LinkAura Daily Fortune" for the zodiac sign: ${sign}.
      Date: Today.
